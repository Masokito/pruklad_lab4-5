...
public class Mob_sms_mms_inet_taruf extends Mob_sms_mms_taruf{
    ...
    Mob_sms_mms_inet_taruf(String name,int clients,double payroll, int minutes, double add_min_price,int num_of_sms,int add_sms_price,int num_of_mms,double add_mms_price,int num_of_inet_megs,int inet_megs_per_sec_speed,double add_inet_price){
